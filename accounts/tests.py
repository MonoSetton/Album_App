...
#
#     def test_update_username_form(self):
#         form_data = {
#             'username': 'testformusername'
#         }
...
#         self.assertTrue(form.is_valid())
#
#     def test_update_email_form(self):
#         form_data = {
#             'email': 'testformemail@gmail.com'
#         }
...
class AccountsViewsTestCase(TestCase):
    ...
    def test_change_password_post_valid_form_correct_old_password(self):
        self.client.login(username='testuser', password='password123')
        test_form_data = {
    ...
    def test_change_password_post_valid_form_incorrect_old_password(self):
        self.client.login(username='testuser', password='password123')
        test_form_data = {
    ...
    def test_change_password_post_invalid_form(self):
        self.client.login(username='testuser', password='password123')
        test_form_data = {
            'oldpassword': 'password123',
